...
class TransUNet(nn.Module):
    def __init__(self, img_size=128, in_channels=3, num_classes=1, head_num=4, mlp_dim=512, 
                 block_num=8, patch_dim=16, base_channels=128):
        super().__init__()

        self.encoder = Encoder(img_size, in_channels, base_channels,
