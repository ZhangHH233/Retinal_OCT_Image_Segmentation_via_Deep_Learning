...
class UNeXt(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=9, img_size=224, deep_supervision=False, 
                 embed_dims=[128, 160, 256], num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4], 
...
class UNext_S(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=9, img_size=224, deep_supervision=False,
                 embed_dims=[32, 64, 128, 512], num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4],
                 qkv_bias=False, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
                 drop_path_rate=0., norm_layer=nn.LayerNorm, depths=[1, 1, 1],
                 sr_ratios=[8, 4, 2, 1], **kwargs):
        super().__init__()
